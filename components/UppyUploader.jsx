...
function App() {
    ...
    const uppy = useUppyWithSupabase({ bucketName: "notes" });
...
export const useUppyWithSupabase = ({ bucketName }) => {
    ...
    const projectURL = process.env.NEXT_PUBLIC_SUPABASE_URL; // Supabase project URL
    const anonKey = process.env.NEXT_PUBLIC_SUPABASE_ANON_KEY; // Supabase anonymous key
