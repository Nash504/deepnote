...
export default function Home() {
  ...
  const exampleAIMessage =
    "Operating systems are the foundational software that makes our computers, smartphones, and even smartwatches actually work. ";
  ...
  return (
    <div
      className={`bg-gradient-to-b from-black to-neutral-900 text-white font-space-grotesk  min-h-screen p-4 sm:p-8 overflow-hidden`}
    >
      {/* Background particles/grid effect */}

      <div
        className={`relative z-10 flex flex-col -mt-10 lg:flex-row gap-12 max-w-6xl mx-auto transition-all duration-1000 ease-out ${mainAnimationClasses}`}
        ref={mainRef}
      >
        ...
        <div className="flex flex-col gap-8 items-center lg:items-start flex-1 mt-16 lg:mt-32">
          ...
          <h2 className="font-medium text-2xl sm:text-6xl lg:text-7xl text-center lg:text-left leading-tight">
            <span className="bg-gradient-to-r from-lime-300 via-lime-300 to-lime-300 bg-clip-text text-transparent">
              Instant PDF
            </span>{" "}
            Answers.
            <br /> Study Smarter.
          ...
          <p className="font-light text-xl text-center lg:text-left text-gray-300 max-w-lg">
            Query your study materials with AI. Unlock rapid understanding and
            pinpoint key information within your notes and texts. Fast, focused
            learning.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto mt-6">
            {/* --- CHANGE: Conditional Buttons Start Here --- */}

            {/* This button shows ONLY if the user is SIGNED OUT */}
            <SignedOut>
            ...
            {/* This button shows ONLY if the user is SIGNED IN */}
            <SignedIn>
              <Link href="/work">
                <Button className="bg-lime-400 hover:bg-lime-300 text-black font-bold text-lg py-6 px-8 rounded-full transition-all duration-300 ease-in-out w-full sm:w-auto flex items-center justify-center gap-2 shadow-lg shadow-lime-400/20">
                  Go to Dashboard
        ...
        <div
          className={`flex justify-center flex-1 mt-12 lg:mt-24 transition-all duration-1000 ease-out delay-300 ${chatAnimationClasses}`}
          ref={chatRef}
        >
          <Card className="w-full sm:max-w-md bg-neutral-900/80 backdrop-blur-md rounded-xl shadow-2xl shadow-lime-400/5 flex flex-col h-[600px] relative overflow-hidden border border-white/10">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-6">
              ...
              <div
                className={`flex justify-start gap-3 transition-opacity duration-500 ${
              ...
              <div
                className={`flex justify-end gap-3 transition-all duration-500 delay-1000 ${
                  isLoaded && chatInView
                    ? "opacity-100 translate-y-0"
              ...
              {/* AI typing indicator */}
              <div
                className={`flex justify-start gap-3 transition-all duration-500 delay-1500 ${
                  isLoaded && chatInView
                    ? "opacity-100 translate-y-0"
                    : "opacity-0 translate-y-4"
                }`}
      ...
      <div
        className={`relative z-10 mt-24 max-w-6xl mx-auto transition-all duration-1000 ease-out ${
          mainInView
